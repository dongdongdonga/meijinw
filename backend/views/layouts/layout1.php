    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">VITAWEB - 后台管理</a>
                ...
                <ul class="nav pull-right">                
                    ...
                    <li class="settings hidden-phone">
                        <!--yii提供的类可以动态生成URL地址(登出：public/logout)-->
